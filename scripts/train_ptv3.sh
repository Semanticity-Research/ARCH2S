...
CONFIG=semseg-pt-v3m1-1-ppt-extreme
# CONFIG=semseg-srbim-v1m1-0-base
# EXP_NAME=debug

# EXP_NAME=semseg-pt-v3m1-0-rpe-s3dis
EXP_NAME=semseg-pt-v3m1-0-rpe-arch2s
EXP_NAME=semseg-pt-v3m1-1-ppt-extreme
WEIGHT="None"
